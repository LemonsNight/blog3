...
// 网站名称
export const SITE_TITLE = 'Lemon Blog';

// 网站的副标题
export const SITE_DESCRIPTION = '一个简单的blog';

// 博主的昵称
export const SITE_AUTHOR_NAME = "lemon";

// 博主的头像
export const SITE_AUTHOR_AVATAR = authorAvatarImage;

// 网站版权起始年份
export const SITE_COPYRIGHT_YEAR_START = "2022";
...
export const SITE_MENU: { title: string, href: string, target: string }[] = [
    ...
    { title: "外部链接", href: "https://space.bilibili.com/7875140?spm_id_from=333.1007.0.0", target: "_blank" }
]
